...
const Footer = ({disabled,onClick,title,isFavorite,authorLabel,createdAtLabel}:boardFooterProps) => {
    ...
    const handleCick=(event:React.MouseEvent<HTMLButtonElement,MouseEvent>)=>{
    ...
    return ( 
        <div className="relative bg-white p-3">
            ...
            <button onClick={handleCick} disabled={disabled} className={cn("opacity-0 group-hover:opacity-100 transition text-blue-800 absolute right-3 top-3 text-muted-foreground ",disabled && "cursor-not-allowed opacity-75")}>
